...
const es = {
  home: {
    ...
    instruction:
      'Por favor, responda las preguntas con calma. Completar la encuesta tomará aproximadamente de 30 a 60 segundos.',
    lang: 'Seleccione el idioma con el que se sienta más familiarizado/a:',
  },
  survey: {
    instruction:
      'Tu objetivo es seleccionar la opción que coincida con el color de fuente de la palabra',
    question:
      'Por favor, selecciona la opción que coincida con el color de fuente de la palabra de entre las 5 opciones de colores',
    pleaseRead: 'Por favor, lee las instrucciones cuidadosamente.',
    ready: 'Estoy listo/a',
  },
  result: {
    instruction:
      'Por favor, complete el siguiente formulario. Su informe de prueba se mostrará después de enviar el formulario.',
    ...
    invalidData:
      'Conjunto de datos no válido, demasiados tiempos de espera o respuestas incorrectas. Por favor, realice la prueba nuevamente. Gracias',
  ...
  messages: {
    ...
    error:
      'Se produjo un error. Por favor, póngase en contacto con el administrador o el desarrollador.',
